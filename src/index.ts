...
import { definePlugin, plugin } from './plugins/index.js';

export { definePlugin, plugin, PluginManager } from './plugins/index.js';
export type { Plugin, PluginContext, PluginDisposer, PluginMetadata, ScopedEventRouter } from './plugins/index.js';
...
export const SakuCore = { definePlugin, plugin };
